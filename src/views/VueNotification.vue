<template>
    <div id="app">
        ...
        <div class="content">
            <p>CSS animation:</p>
            <div>
                <button class="success" style="width: 30%" @click="show('foo-css', 'success')">
                    <i class="icon ion-information-circled" />
                    SUCCESS
                </button>
                <button class="warn" style="width: 30%" @click="show('foo-css', 'warn')">
                    <i class="icon ion-alert-circled" />
                    WARNING
                </button>
                <button class="error" style="width: 30%" @click="show('foo-css', 'error')">
